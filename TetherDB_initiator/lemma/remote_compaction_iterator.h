...
class RemoteCompactionIterator {
 public:
  ...
  class RealCompaction : public CompactionProxy {
   public:
    explicit RealCompaction(const RemoteCompaction* compaction)
   ...
   private:
    const RemoteCompaction* compaction_;
  };

  RemoteCompactionIterator(InternalIterator* input, const Comparator* cmp,
                     ...
                     const RemoteCompaction* compaction = nullptr,
