...
class SpdkEnv : public FileSystemWrapper { //EnvWrapper {
 public:
  ...
  virtual void SpdkMigration(std::string dbpath, std::string data_path) override;
...
//                          const std::string& target) override;
  ...
  virtual void SetLevel(const std::string& fname, int level) override;
 ...
 private:
  ...
  static void read_thread(std::unique_ptr<FSRandomAccessFile> result, size_t size);
