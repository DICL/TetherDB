...
class TopFSCache{
public:
	virtual bool Insert(const TKey& key, const TValue& value, bool is_l0 = false, bool by_compaction = false)=0;
	virtual bool Find(const TKey& key, TValue& value, bool for_compaction, int level)=0;
