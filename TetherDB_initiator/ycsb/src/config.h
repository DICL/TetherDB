...
utils::Properties gen_workload_props(const char wl_char, const utils::Properties& props) {
  ...
  switch (wl_char) {
    ...
    case 'g': {
      wp.SetProperty("readproportion", "0"); 
      wp.SetProperty("updateproportion", "1");
      wp.SetProperty("scanproportion", "0.0"); 
      wp.SetProperty("insertproportion", "0");
      wp.SetProperty("readmodifywriteproportion", "0");
      wp.SetProperty("workloadname", "Workload G");
      break;
    }
    case 'h': {
      wp.SetProperty("readproportion", "0.25"); 
      wp.SetProperty("updateproportion", "0.75");
      wp.SetProperty("scanproportion", "0.0"); 
      wp.SetProperty("insertproportion", "0");
      wp.SetProperty("readmodifywriteproportion", "0");
      wp.SetProperty("workloadname", "Workload H");
      break;
    }
    case 'i': {
      wp.SetProperty("readproportion", "0.75"); 
      wp.SetProperty("updateproportion", "0.25");
      wp.SetProperty("scanproportion", "0.0"); 
      wp.SetProperty("insertproportion", "0");
      wp.SetProperty("readmodifywriteproportion", "0");
      wp.SetProperty("workloadname", "Workload I");
      break;
    }
    default: {
...
void set_default_props(utils::Properties* props) {
  ...
  props->SetProperty("max_background_jobs", "20");
}
