...
struct AdvancedColumnFamilyOptions {
  ...
  //
  // Dynamically changeable through SetOptions() API
  int level0_slowdown_writes_trigger = 20;//lemma
  //int level0_slowdown_writes_trigger = 30;
  ...
  uint64_t soft_pending_compaction_bytes_limit = 512 * 1073741824ull;
  ...
  //
  // Dynamically changeable through SetOptions() API
  uint64_t hard_pending_compaction_bytes_limit = 1024 * 1073741824ull;
