...
extern PROTOBUF_INTERNAL_EXPORT_prefetch_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PrefetchMsg_prefetch_2eproto;
namespace prefetch {
class PrefetchMsgDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PrefetchMsg> _instance;
} _PrefetchMsg_default_instance_;
class PrefetchRequestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PrefetchRequest> _instance;
} _PrefetchRequest_default_instance_;
class PrefetchReplyDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PrefetchReply> _instance;
} _PrefetchReply_default_instance_;
}  // namespace prefetch
static void InitDefaultsscc_info_PrefetchMsg_prefetch_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::prefetch::_PrefetchMsg_default_instance_;
    new (ptr) ::prefetch::PrefetchMsg();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PrefetchMsg_prefetch_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_PrefetchMsg_prefetch_2eproto}, {}};

static void InitDefaultsscc_info_PrefetchReply_prefetch_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::prefetch::_PrefetchReply_default_instance_;
    new (ptr) ::prefetch::PrefetchReply();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PrefetchReply_prefetch_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_PrefetchReply_prefetch_2eproto}, {}};

static void InitDefaultsscc_info_PrefetchRequest_prefetch_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::prefetch::_PrefetchRequest_default_instance_;
    new (ptr) ::prefetch::PrefetchRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_PrefetchRequest_prefetch_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_PrefetchRequest_prefetch_2eproto}, {
      &scc_info_PrefetchMsg_prefetch_2eproto.base,}};
...
const char descriptor_table_protodef_prefetch_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_prefetch_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_prefetch_2eproto_sccs[3] = {
  &scc_info_PrefetchMsg_prefetch_2eproto.base,
  &scc_info_PrefetchReply_prefetch_2eproto.base,
  &scc_info_PrefetchRequest_prefetch_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_prefetch_2eproto = {
  false, false, descriptor_table_protodef_prefetch_2eproto, "prefetch.proto", 305,
  &descriptor_table_prefetch_2eproto_once, descriptor_table_prefetch_2eproto_sccs, descriptor_table_prefetch_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_prefetch_2eproto::offsets,
  file_level_metadata_prefetch_2eproto, 3, file_level_enum_descriptors_prefetch_2eproto, file_level_service_descriptors_prefetch_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_prefetch_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_prefetch_2eproto)), true);
namespace prefetch {
...
const PrefetchMsg& PrefetchMsg::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_PrefetchMsg_prefetch_2eproto.base);
...
void PrefetchRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_PrefetchRequest_prefetch_2eproto.base);
}
...
const PrefetchRequest& PrefetchRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_PrefetchRequest_prefetch_2eproto.base);
  return *internal_default_instance();
}
...
const PrefetchReply& PrefetchReply::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_PrefetchReply_prefetch_2eproto.base);
  return *internal_default_instance();
}
