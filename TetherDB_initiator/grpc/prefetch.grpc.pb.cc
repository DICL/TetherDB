...
std::unique_ptr< Prefetcher::Stub> Prefetcher::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< Prefetcher::Stub> stub(new Prefetcher::Stub(channel));
  return stub;
}

Prefetcher::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_PrefetchData_(Prefetcher_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
