...
InternalIterator* TableCache::NewIterator(
  ...
  if (table_reader == nullptr) {
    //fprintf(stderr, "\n@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ FindTable 222  fd.GetNumber() = %lu  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n", fd.GetNumber());//lemmalemmalemma
    s = FindTable(
  ...
  if (handle != nullptr) {
    ReleaseHandle(handle);
    fprintf(stderr, "ReleaseHandle NewIterator\n");
  }
  if (!s.ok()) {
...
Status TableCache::Get(const ReadOptions& options,
  ...
  if (handle != nullptr) {
    ReleaseHandle(handle);
    fprintf(stderr, "ReleaseHandle Get\n");
  }
  return s;
}
...
Status TableCache::MultiGet(const ReadOptions& options,
  ...
  if (handle != nullptr) {
    ReleaseHandle(handle);
    fprintf(stderr, "ReleaseHandle MultiGet \n");
  }
  return s;
}
...
Status TableCache::GetTableProperties(
  ...
  *properties = table->GetTableProperties();
  ...
  fprintf(stderr, "ReleaseHandle GetTableProperties \n");
  return s;
}
...
size_t TableCache::GetMemoryUsageByTableReader(
  ...
  ReleaseHandle(table_handle);
  fprintf(stderr, "ReleaseHandle GetMemoryUsageByTableReader\n");
  return ret;
}
...
uint64_t TableCache::ApproximateOffsetOf(
  ...
  if (table_handle != nullptr) {
    ReleaseHandle(table_handle);
    //fprintf(stderr, "ReleaseHandle ApproximateOffsetOf\n");
  }
...
uint64_t TableCache::ApproximateSize(
  ...
  if (table_handle != nullptr) {
    ReleaseHandle(table_handle);
    //fprintf(stderr, "ReleaseHandle ApproximateSize\n");
  }
