...
#if LEMMA_L0
  uint64_t GetLogNumber() { return logfile_number_; }
  void SetLogNumber(uint64_t num) { logfile_number_ = num; }
  //void SetLog(bool* log1, bool* log2) { log1_ = log1; log2_ = log2; }
