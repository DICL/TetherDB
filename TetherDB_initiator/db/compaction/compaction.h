...
class Compaction {
 public:
  Compaction(VersionStorageInfo* input_version,
             ...
             CompactionReason compaction_reason = CompactionReason::kUnknown, size_t total_len = 0, int base_index = 0);
...
#if REMOTE_COMPACTION
  void AddInputDeletions(VersionEdit* out_edit, compaction_data::LocalCompactionRequest* local_compaction_result);
  void AddInputDeletions(compaction_data::LocalCompactionRequest* local_compaction_result);
#endif
...
#endif
  uint32_t TotalLen() { return total_len_; }
  uint32_t BaseIndex() { return base_index_; }
 private:
