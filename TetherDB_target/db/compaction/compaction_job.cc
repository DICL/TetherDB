...
void CompactionJob::ProcessKeyValueCompaction(SubcompactionState* sub_compact) {
#if DEBUG_PRINT
  fprintf(stderr, "\n!!! CompactionJob::ProcessKeyValueCompaction called\n"); //lemma
#endif
  ...
  fprintf(stderr, "\n!!! CompactionJob::ProcessKeyValueCompaction before while\n"); //lemma
  ...
  fprintf(stderr, "\n!!! CompactionJob::ProcessKeyValueCompaction after while\n"); //lemma
  ...
  fprintf(stderr, "\n!!! CompactionJob::ProcessKeyValueCompaction after while 111\n"); //lemma
  ...
  fprintf(stderr, "\n!!! CompactionJob::ProcessKeyValueCompaction after while 222\n"); //lemma
  ...
  fprintf(stderr, "\n!!! CompactionJob::ProcessKeyValueCompaction after while 333\n"); //lemma
}
