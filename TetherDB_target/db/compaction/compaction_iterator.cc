...
void CompactionIterator::NextFromInput() {
  ...
  while (!valid_ && input_->Valid() && !IsPausingManualCompaction() &&
    ...
    value_ = input_->value();
#if LEMMA_L0
    log_offset_ = input_->log_offset();//lemmalemmalemma
#endif
    ...
    if (need_skip) {
      fprintf(stderr, "KeyNotExistsBeyondOutputLevel 111 \n");//lemma
      // This case is handled below.
    } else if (clear_and_output_next_key_) {
      fprintf(stderr, "KeyNotExistsBeyondOutputLevel 222 \n");//lemma
      ...
      fprintf(stderr, "KeyNotExistsBeyondOutputLevel 333 \n");//lemma
      ...
      // in this snapshot.
      //fprintf(stderr, "KeyNotExistsBeyondOutputLevel 444 \n");//lemma
      ...
      fprintf(stderr, "KeyNotExistsBeyondOutputLevel 555 \n");//lemma
      ++iter_stats_.num_record_drop_obsolete;
      if (!bottommost_level_) {
        ++iter_stats_.num_optimized_del_drop_obsolete;
      }
      ...
      fprintf(stderr, "KeyNotExistsBeyondOutputLevel 666 \n");//lemma
      ...
      fprintf(stderr, "KeyNotExistsBeyondOutputLevel 777 \n");//lemma
