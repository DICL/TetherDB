...
#if ROCKSDB_SPDK
void DBOptions::SetSpdkEnv(std::string addr, int queue_start, int cache_size, int MULTI_NUM, int MY_ID) {
  spdk_fs = NewSpdkEnv(env->GetFileSystem(), env, addr, spdk_open_mode, queue_start, cache_size, MULTI_NUM, MY_ID);
}
#endif
